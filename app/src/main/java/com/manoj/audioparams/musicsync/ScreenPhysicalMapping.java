...
class ScreenPhysicalMapping {
    ...
    ScreenPhysicalMapping(double _nCanvasPixel, double _vLowerBound, double _vHigherBound, Type _mapType) {
    ...
    void setMappingType(Type _mapType, double lower_bound_ref) {
